GTCEuStartupEvents.registry('gtceu:recipe_type', event => {
    event.create('neutronium_collision_chamber')
        .category('neutronium_collision_chamber')
        .setEUIO('in')
...
GTCEuStartupEvents.registry('gtceu:machine', event => {
        event.create("neutronium_collision_chamber", "multiblock")
        .rotationState(RotationState.NON_Y_AXIS)
        .recipeTypes("neutronium_collision_chamber")
