GTCEuStartupEvents.registry('gtceu:recipe_type', event => {
    event.create('superpositioned_draconic_compression_reactor')
        .category('superpositioned_draconic_compression_reactor')
        .setEUIO('out')
...
GTCEuStartupEvents.registry('gtceu:machine', event => {
        event.create("superpositioned_draconic_compression_reactor", "multiblock")
        .rotationState(RotationState.NON_Y_AXIS)
        .recipeTypes("superpositioned_draconic_compression_reactor")
