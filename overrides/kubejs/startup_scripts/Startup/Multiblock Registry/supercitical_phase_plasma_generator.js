GTCEuStartupEvents.registry('gtceu:recipe_type', event => {
    event.create('supercitical_phase_plasma_generator')
        .category('supercitical_phase_plasma_generator')
        .setEUIO('out')
...
GTCEuStartupEvents.registry('gtceu:machine', event => {
        event.create("supercitical_phase_plasma_generator", "multiblock")
        .rotationState(RotationState.NON_Y_AXIS)
        .recipeTypes("supercitical_phase_plasma_generator")
